package circuitsim;// stub circuitsim.PhotoResistorElm based on circuitsim.SparkGapElm
// FIXME need to uncomment circuitsim.PhotoResistorElm line from circuitsim.CirSim.java
// FIXME need to add circuitsim.PhotoResistorElm.java to srclist
...
class PhotoResistorElm extends CircuitElm {
	...
	draw2Leads(g);
	// FIXME need to draw properly, see circuitsim.ResistorElm.java
