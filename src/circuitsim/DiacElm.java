package circuitsim;// stub implementation of circuitsim.DiacElm, based on circuitsim.SparkGapElm
// FIXME need to add circuitsim.DiacElm.java to srclist
// FIXME need to uncomment circuitsim.DiacElm line from circuitsim.CirSim.java
