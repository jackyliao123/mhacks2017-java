package circuitsim;// circuitsim.CirSim.java (c) 2010 by Paul Falstad
...
public class CirSim extends Frame
    ...
    public void init() {
        ...
        mainMenu.add(getClassCheckItem("Add Wire", "circuitsim.WireElm"));
        mainMenu.add(getClassCheckItem("Add Resistor", "circuitsim.ResistorElm"));
        ...
        passMenu.add(getClassCheckItem("Add Potentiometer", "circuitsim.PotElm"));
        passMenu.add(getClassCheckItem("Add Transformer", "circuitsim.TransformerElm"));
        passMenu.add(getClassCheckItem("Add Tapped Transformer",
                "circuitsim.TappedTransformerElm"));
        passMenu.add(getClassCheckItem("Add Transmission Line", "circuitsim.TransLineElm"));
        passMenu.add(getClassCheckItem("Add Relay", "circuitsim.RelayElm"));
        passMenu.add(getClassCheckItem("Add Memristor", "circuitsim.MemristorElm"));
        passMenu.add(getClassCheckItem("Add Spark Gap", "circuitsim.SparkGapElm"));

        Menu inputMenu = new Menu("Inputs/Outputs");
        mainMenu.add(inputMenu);
        inputMenu.add(getClassCheckItem("Add Ground", "circuitsim.GroundElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (2-terminal)", "circuitsim.DCVoltageElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (2-terminal)", "circuitsim.ACVoltageElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (1-terminal)", "circuitsim.RailElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (1-terminal)", "circuitsim.ACRailElm"));
        inputMenu.add(getClassCheckItem("Add Square Wave (1-terminal)", "circuitsim.SquareRailElm"));
        inputMenu.add(getClassCheckItem("Add Analog Output", "circuitsim.OutputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Input", "circuitsim.LogicInputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Output", "circuitsim.LogicOutputElm"));
        inputMenu.add(getClassCheckItem("Add Clock", "circuitsim.ClockElm"));
        inputMenu.add(getClassCheckItem("Add A/C Sweep", "circuitsim.SweepElm"));
        inputMenu.add(getClassCheckItem("Add Var. Voltage", "circuitsim.VarRailElm"));
        inputMenu.add(getClassCheckItem("Add Antenna", "circuitsim.AntennaElm"));
        inputMenu.add(getClassCheckItem("Add AM source", "circuitsim.AMElm"));
        inputMenu.add(getClassCheckItem("Add FM source", "circuitsim.FMElm"));
        inputMenu.add(getClassCheckItem("Add Current Source", "circuitsim.CurrentElm"));
        inputMenu.add(getClassCheckItem("Add LED", "circuitsim.LEDElm"));
        inputMenu.add(getClassCheckItem("Add Lamp (beta)", "circuitsim.LampElm"));
        inputMenu.add(getClassCheckItem("Add LED Matrix", "circuitsim.LEDMatrixElm"));
        ...
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, PNP)",
                "circuitsim.PTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (- on top)", "circuitsim.OpAmpElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (+ on top)",
                "circuitsim.OpAmpSwapElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (n-channel)",
                "circuitsim.NMosfetElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (p-channel)",
                "circuitsim.PMosfetElm"));
        activeMenu.add(getClassCheckItem("Add JFET (n-channel)",
                "circuitsim.NJfetElm"));
        activeMenu.add(getClassCheckItem("Add JFET (p-channel)",
                "circuitsim.PJfetElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPST)", "circuitsim.AnalogSwitchElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPDT)", "circuitsim.AnalogSwitch2Elm"));
        activeMenu.add(getClassCheckItem("Add Tristate buffer", "circuitsim.TriStateElm"));
        activeMenu.add(getClassCheckItem("Add Schmitt Trigger", "circuitsim.SchmittElm"));
        ...
        //activeMenu.add(getClassCheckItem("Add Photoresistor", "circuitsim.PhotoResistorElm"));
        //activeMenu.add(getClassCheckItem("Add Thermistor", "circuitsim.ThermistorElm"));
        activeMenu.add(getClassCheckItem("Add CCII+", "circuitsim.CC2Elm"));
        activeMenu.add(getClassCheckItem("Add CCII-", "circuitsim.CC2NegElm"));

        Menu gateMenu = new Menu("Logic Gates");
        mainMenu.add(gateMenu);
        gateMenu.add(getClassCheckItem("Add Inverter", "circuitsim.InverterElm"));
        gateMenu.add(getClassCheckItem("Add NAND Gate", "circuitsim.NandGateElm"));
        gateMenu.add(getClassCheckItem("Add NOR Gate", "circuitsim.NorGateElm"));
        gateMenu.add(getClassCheckItem("Add AND Gate", "circuitsim.AndGateElm"));
        gateMenu.add(getClassCheckItem("Add OR Gate", "circuitsim.OrGateElm"));
        gateMenu.add(getClassCheckItem("Add XOR Gate", "circuitsim.XorGateElm"));

        Menu chipMenu = new Menu("Chips");
        mainMenu.add(chipMenu);
        chipMenu.add(getClassCheckItem("Add D Flip-Flop", "circuitsim.DFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add JK Flip-Flop", "circuitsim.JKFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add T Flip-Flop", "circuitsim.TFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add 7 Segment LED", "circuitsim.SevenSegElm"));
        chipMenu.add(getClassCheckItem("Add 7 Segment Decoder", "circuitsim.SevenSegDecoderElm"));
        chipMenu.add(getClassCheckItem("Add Multiplexer", "circuitsim.MultiplexerElm"));
        chipMenu.add(getClassCheckItem("Add Demultiplexer", "circuitsim.DeMultiplexerElm"));
        chipMenu.add(getClassCheckItem("Add SIPO shift register", "circuitsim.SipoShiftElm"));
        chipMenu.add(getClassCheckItem("Add PISO shift register", "circuitsim.PisoShiftElm"));
        chipMenu.add(getClassCheckItem("Add Phase Comparator", "circuitsim.PhaseCompElm"));
        chipMenu.add(getClassCheckItem("Add Counter", "circuitsim.CounterElm"));
        chipMenu.add(getClassCheckItem("Add Decade Counter", "circuitsim.DecadeElm"));
        chipMenu.add(getClassCheckItem("Add 555 Timer", "circuitsim.TimerElm"));
        chipMenu.add(getClassCheckItem("Add DAC", "circuitsim.DACElm"));
        chipMenu.add(getClassCheckItem("Add ADC", "circuitsim.ADCElm"));
        chipMenu.add(getClassCheckItem("Add Latch", "circuitsim.LatchElm"));
        //chipMenu.add(getClassCheckItem("Add Static RAM", "circuitsim.SRAMElm"));
        chipMenu.add(getClassCheckItem("Add Sequence generator", "circuitsim.SeqGenElm"));
        chipMenu.add(getClassCheckItem("Add VCO", "circuitsim.VCOElm"));
        chipMenu.add(getClassCheckItem("Add Full Adder", "circuitsim.FullAdderElm"));
        chipMenu.add(getClassCheckItem("Add Half Adder", "circuitsim.HalfAdderElm"));
        chipMenu.add(getClassCheckItem("Add Monostable", "circuitsim.MonostableElm"));
...
//	    dispose();
    ...
    public synchronized void parseComponents(ArrayList<Component> components, ArrayList<Wire> wires) {
        ...
        for (Component comp : components) {
            ...
            switch (comp.type) {
                ...
                case "LED":
                    ...
                    elm = new LEDElm(x1, y1, x2, y2, 0, new StringTokenizer("1 0 0"));
                    break;
                case "inductor":
...
//	    impDialog = new circuitsim.ImportExportClipboardDialog(this,
//		circuitsim.ImportExportDialog.Action.IMPORT);
        pushUndo();
        impDialog.execute();
    }
...
//	    expDialog = new circuitsim.ImportExportClipboardDialog(this,
//		 circuitsim.ImportExportDialog.Action.EXPORT);
        }
