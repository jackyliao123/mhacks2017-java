package circuitsim;// stub implementation of circuitsim.TriacElm, based on circuitsim.SCRElm
// FIXME need to add circuitsim.TriacElm to srclist
// FIXME need to uncomment circuitsim.TriacElm line from circuitsim.CirSim.java
