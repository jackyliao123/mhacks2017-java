package circuitsim;// stub circuitsim.ThermistorElm based on circuitsim.SparkGapElm
// FIXME need to uncomment circuitsim.ThermistorElm line from circuitsim.CirSim.java
// FIXME need to add circuitsim.ThermistorElm.java to srclist
